...
MODE_PRESETS = {
    "easy":      {"grid_size": 10, "allow_backwards": False, "mask": None, "min_words": 7,  "max_words": 12},
    "normal":    {"grid_size": 13, "allow_backwards": True,  "mask": None, "min_words": 10, "max_words": 15},
    "hard":      {"grid_size": 15, "allow_backwards": True,  "mask": None, "min_words": 13, "max_words": 20},
    "veryhard":  {"grid_size": 18, "allow_backwards": True,  "mask": None, "min_words": 15, "max_words": 25},
    "nightmare": {"grid_size": 20, "allow_backwards": True,  "mask": None, "min_words": 18, "max_words": 30},
    "bonus":     {"grid_size": 15, "allow_backwards": True,  "mask": "circle", "min_words": 7,  "max_words": 15},
}
