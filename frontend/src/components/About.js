        ...
        <div className="about-content">
          <div className="about-section">
            ...
            <p>
              ...
              originally developed as a command-line tool. It allows users to
              create custom word search puzzles with different difficulty
              levels, topics, and configurations. Now available as a web
              application, BOOP makes puzzle creation accessible to everyone
          ...
          <div className="about-section">
            ...
            <p>You can customize your puzzle book by:</p>
            <ul>
          ...
          <div className="about-section">
            ...
            <p>
              ...
              creation as simple as a few clicks.
            </p>
          </div>
