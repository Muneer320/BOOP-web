...
const PrivacyPolicy = () => {
  return (
    <div className="font-sans bg-gray-50">
      <Helmet>
        <title>Privacy Policy - BOOP Web</title>
        <meta
          name="description"
          content="Privacy Policy for BOOP Web application"
        />
      </Helmet>

      <div className="container mx-auto px-4 py-12 max-w-4xl bg-white shadow-sm rounded-lg my-8">
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-700">
          <li className="mb-3">
            <p className="mb-1">
              <strong className="font-medium">Account</strong> means a unique
          ...
          <li className="mb-3">
            <p className="mb-1">
              <strong className="font-medium">Affiliate</strong> means an entity
          ...
          <li className="mb-3">
            <p className="mb-1">
              <strong className="font-medium">Company</strong> (referred to as
              either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
              &quot;Our&quot; in this Agreement) refers to BOOP-web.
            </p>
          </li>
          <li className="mb-3">
            <p className="mb-1">
              <strong className="font-medium">Cookies</strong> are small files
          ...
          <li className="mb-3">
            <p className="mb-1">
              <strong className="font-medium">Country</strong> refers to: Delhi,
              India
            </p>
          </li>
          <li className="mb-3">
            <p className="mb-1">
              <strong className="font-medium">Device</strong> means any device
          ...
          <li className="mb-3">
            <p className="mb-1">
              <strong className="font-medium">Personal Data</strong> is any
          ...
          <li className="mb-3">
            <p className="mb-1">
              <strong className="font-medium">Service</strong> refers to the
              Website.
            </p>
          </li>
          <li className="mb-3">
            <p className="mb-1">
              <strong className="font-medium">Service Provider</strong> means
          ...
          <li className="mb-3">
            <p className="mb-1">
              <strong className="font-medium">Usage Data</strong> refers to data
          ...
          <li className="mb-3">
            <p className="mb-1">
              <strong className="font-medium">Website</strong> refers to
              BOOP-web, accessible from
              <a
                href="https://boop-web.vercel.app/"
          ...
          <li className="mb-3">
            <p className="mb-1">
              <strong className="font-medium">You</strong> means the individual
        ...
        <h4 className="text-lg font-medium mb-3 mt-6 text-gray-700">
          Personal Data
        </h4>
        <p className="text-gray-700 mb-4 leading-relaxed">
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-700">
          <li className="mb-3">Usage Data</li>
        </ul>
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-700">
          <li className="mb-3">
            <strong className="font-medium">Cookies or Browser Cookies.</strong>{" "}
          ...
          <li className="mb-3">
            <strong className="font-medium">Web Beacons.</strong> Certain
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-700">
          ...
          <li className="mb-3">
            <p className="mb-1">
              <strong className="font-medium">Functionality Cookies</strong>
            </p>
            <p className="mb-1">Type: Persistent Cookies</p>
            <p className="mb-1">Administered by: Us</p>
            <p className="mb-1">
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-700">
          ...
          <li className="mb-3">
            <p className="mb-1">
              <strong className="font-medium">To manage Your Account:</strong>{" "}
          ...
          <li className="mb-3">
            <p className="mb-1">
              <strong className="font-medium">To contact You:</strong> To
          ...
          <li className="mb-3">
            <p className="mb-1">
              <strong className="font-medium">To manage Your requests:</strong>{" "}
              To attend and manage Your requests to Us.
            </p>
          </li>
          <li className="mb-3">
            <p className="mb-1">
              <strong className="font-medium">For business transfers:</strong>{" "}
          ...
          <li className="mb-3">
            <p className="mb-1">
              <strong className="font-medium">For other purposes</strong>: We
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-700">
          ...
          <li className="mb-3">
            <strong className="font-medium">With Affiliates:</strong> We may
        ...
        <ul className="list-disc pl-6 mb-6 text-gray-700">
          <li className="mb-3">
            ...
            <a
              href="https://github.com/Muneer320/BOOP-web/issues/new"
              rel="external nofollow noreferrer"
              target="_blank"
              className="text-blue-600 hover:text-blue-800 hover:underline ml-1 font-medium"
            >
              https://github.com/Muneer320/BOOP-web/issues/new
            </a>
          </li>
        </ul>
      </div>
