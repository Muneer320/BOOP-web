...
const TermsOfService = () => {
  return (
    <div className="font-sans bg-gray-50">
      <Helmet>
        <title>Terms of Service - BOOP Web</title>
        <meta
          name="description"
          content="Terms and conditions for using BOOP Web application"
        />
      </Helmet>
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl bg-white shadow-sm rounded-lg my-8">
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">
          We are BOOP-web ('Company', 'we', 'us', or 'our').
        </p>
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">
          You can contact us by opening an issue on our GitHub repository.
        </p>

        <p className="text-gray-700 mb-4 leading-relaxed">
          These Legal Terms constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity ('you'), and
          BOOP-web, concerning your access to and use of the Services. You agree
        ...
        <h2 className="text-2xl font-semibold mt-10 mb-4 text-gray-800" id="ip">
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">
          ...
          of India. BOOP-web and yourself irrevocably consent that the courts of
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">
          ...
          the jurisdiction of the India courts. BOOP-web shall also maintain the
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">
          ...
          OF THE AMOUNT PAID, IF ANY, BY YOU TO US OR $100.00 USD. CERTAIN US
        ...
        <p className="text-gray-700 mb-4 leading-relaxed font-bold">BOOP-web</p>
        <p className="text-gray-700 mb-4 leading-relaxed">
          You can open an issue on our GitHub repository at:{" "}
          <a
            href="https://github.com/Muneer320/BOOP-web/issues/new"
            target="_blank"
            rel="noopener noreferrer"
